...
import { usePage, useForm as useInertiaForm, Head } from "@inertiajs/vue3";
    ...
    <div class="h-[calc(100vh-3.5rem)] flex items-center justify-center">
      ...
      >
        <CardHeader>
          ...
          <CardDescription>
            Masukkan username dan password yang sudah didaftarkan ke dalam
            sistem. Apabila terjadi kendala silahkan menghubungi
            <strong>Admin Aplikasi</strong>
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter>
          ...
          >
            <span v-if="loginForm.processing" class="flex items-center gap-2">
              <svg
                class="animate-spin border-sky-500 size-4"
